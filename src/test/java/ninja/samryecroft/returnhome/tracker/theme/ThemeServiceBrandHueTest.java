...
class ThemeServiceBrandHueTest {
    ...
    @CsvSource({
            ...
            "#6f9ee0, 257", // The spec's former "Northgate = 232" example. Creed has since withdrawn
                             ...
                             // for Northgate the two disagree. NOT gamut clipping, which was the
                             // natural guess - hue 232 renders to #259ED1 and converts back to 232,
                             // comfortably in gamut.
            ...
            // Carried from AccentRampTest when the hue derivation was consolidated here (T131).
            // The direction of that consolidation was reversed late, and these are the cases that
            // would otherwise have died with the implementation they were written against.
            "#000000, 265", // the must-keep: all three channels zero through a cube root is a
                             // genuinely distinct path, and the input most likely to misbehave
            "#808080, 265", // mid grey - zero chroma by construction
            "#807F81, 265", // chroma 0.0032, a hair below the floor
    })
