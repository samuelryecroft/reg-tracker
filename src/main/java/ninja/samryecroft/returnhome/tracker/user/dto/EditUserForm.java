...
public class EditUserForm {
     ...
     *
     * AND THIS IS ONE OF TWO CONDITIONS THAT ACTUALLY HOLD. Emailed codes are safe AGAINST A
     ...
     * address. Under a second factor the code therefore goes to the real person's mailbox and the
     * manager is stopped. That is a pre-existing impersonation capability removed.
     *
     * READ UserService.changeEmail BEFORE DECIDING THIS RESTRICTION IS TRADEABLE AGAINST
     * CONVENIENCE - it carries the whole argument, measured.
     */
